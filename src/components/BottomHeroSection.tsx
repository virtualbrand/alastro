...
const BottomHeroSection = () => {
  ...
  return (
  <div id="sobre" className="relative bg-[var(--color-bg-2)] w-full mt-[-5px] min-h-screen z-10 shadow-[0_10px_30px_-5px_rgba(0,0,0,0.2)]">
      <div className="flex flex-col lg:flex-row items-stretch h-full">
        ...
        <div className="w-full lg:w-1/2 lg:min-h-screen">
          <img 
            ...
            className="w-full h-full lg:min-h-screen object-cover object-center filter grayscale"
          />
        </div>
        {/* Texto: 100% em mobile/tablet, 50% em desktop */}
        <div className="w-full lg:w-1/2 flex flex-col justify-center px-8 sm:px-12 md:px-10 lg:px-20 xl:px-24 py-10 md:py-16 bg-[var(--color-bg-2)]">
